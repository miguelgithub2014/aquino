...
<form method="post" action="<?php if(isset ($this->action))echo $this->action ?>" id="frm" enctype="multipart/form-data">
    ...
    <table align="center" cellpadding="10">
        <tr>
            ...
            <td>
                <input type="text" id="titulonot" name="titulonot" class="form-control"
        ...
        <tr>
            ...
            <td>
                <input id="url" name="url" class="form-control" value="<?php if(isset ($this->datos[0]['URL']))echo $this->datos[0]['URL']?>" style="width: 300px" />
            </td>
        </tr>
        <tr>
            ...
            <div id="imagen_subida" style="text-align: center">
                <img width="150px" height="150px" src="<?php echo BASE_URL ?>lib/img/clientes/<?php echo strtolower($this->datos[0]['IMAGEN']) ?>" />
                <br><br>
        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <a href="<?php echo BASE_URL ?>clientes_web" class="btn btn-info">Cancelar</a></p>
            </td>
        </tr>
    </table>
</form>
