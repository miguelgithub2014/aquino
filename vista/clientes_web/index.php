...
<?php if (isset($this->datos) && count($this->datos)) { ?>
    <div class="row-fluid">
        <div>
            ...
            <option value="0">Titulo</option>
                ...
                <a href="<?php echo BASE_URL ?>clientes_web/nuevo" class="btn btn-grey"><i class="icon-plus icon-white"></i> Nuevo</a>
            </div>
            <br/>
        </div>
    </div>
        ...
        <?php for ($i = 0; $i < count($this->datos); $i++) { ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:void(0)" onclick="editar('<?php echo BASE_URL?>clientes_web/editar/<?php echo $this->datos[$i]['ID'] ?>')" class="btn btn-success btn-minier"><i class="icon-pencil icon-white"></i> Editar</a>
                    <a href="javascript:void(0)" onclick="eliminar('<?php echo BASE_URL?>clientes_web/eliminar/<?php echo $this->datos[$i]['ID'] ?>')" class="btn btn-danger btn-minier"><i class="icon-remove icon-white"></i> Eliminar</a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
    ...
    <div class="page-header">
        <p>No hay Clientes de la web</p>
        <a href="<?php echo BASE_URL?>clientes_web/nuevo" class="btn btn-primary">Nuevo</a>
    </div>
<?php } ?>
