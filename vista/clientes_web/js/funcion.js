...
$(function(){
    ...
    function buscar(){
            var HTML='',HTML2='';
            $.post(url+'clientes_web/buscar','cadena='+$("#buscar").val()+'&filtro='+$("#filtro").val(),function(datos){
                ...
                for(var i=0;i<datos.length;i++){
                    ...
                    var editar=url+'clientes_web/editar/'+datos[i].ID; 
                    var eliminar=url+'clientes_web/eliminar/'+datos[i].ID;   
...
function ver(id){
            ...
            html='';titulo='';
           $.post(url+'clientes_web/ver','id='+id,function(datos){
                titulo = datos[0].TITULO;
                imagen = datos[0].IMAGEN;
                html += "<br><br><div class='text-center'><img src='"+url+"lib/img/clientes/"+imagen.toLowerCase()+"' /></div>";
                urll = datos[0].URL;
                html += '<br><article>'+urll+'</article>';
