...
<div class="navbar-inner text-center">
    <div class="row-fluid">
        <div>
            ...
            <option value="0">Codigo</option>
                ...
                <a href="<?php echo BASE_URL ?>param/nuevo" class="btn btn-grey"><i class="icon-plus icon-white"></i></a>
            </div>
            <br/>
        </div>
    </div>
    ...
    <table id="table" class="table table-striped table-bordered table-hover sortable">
        ...
        <?php for ($i = 0; $i < count($this->datos); $i++) { ?>
            <tr>
                <td><?php echo $i+1 ?></td>
                <td><?php echo $this->datos[$i]['ID_PARAM'] ?></td>
                <td><?php echo $this->datos[$i]['VALOR'] ?></td>
...
<div class="navbar-inner text-center" style="padding: 1em;">
        <p>No hay param</p>
        <a href="<?php echo BASE_URL?>param/nuevo" class="btn btn-primary">Nuevo</a>
    <?php } ?>