    ...
    <div class="row-fluid">
        <div>
            ...
            <option value="0">Descripcion</option>
                ...
                <a href="<?php echo BASE_URL ?>perfiles/nuevo" class="btn btn-grey"><i class="icon-plus icon-white"></i></a>
            </div>
            <br/>
        </div>
    </div>
    ...
    <table id="table" class="table table-striped table-bordered table-hover sortable">
        ...
        <?php for ($i = 0; $i < count($this->datos); $i++) { ?>
            <tr>
                ...
                <td>
                    <a href="javascript:void(0)" onclick="editar('<?php echo BASE_URL?>perfiles/editar/<?php echo $this->datos[$i]['ID_PERFIL'] ?>')" class="btn btn-success btn-minier"><i class="icon-pencil icon-white"></i></a>
                    <a href="javascript:void(0)" onclick="eliminar('<?php echo BASE_URL?>perfiles/eliminar/<?php echo $this->datos[$i]['ID_PERFIL'] ?>')" class="btn btn-danger btn-minier"><i class="icon-remove icon-white"></i></a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
