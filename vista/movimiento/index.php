    ...
    <div class="row-fluid">
        <div>
            ...
            <option value="0">Concepto</option>
                ...
                <a href="<?php echo BASE_URL ?>movimiento/nuevo" class="btn btn-grey"><i class="icon-plus icon-white"></i></a>
            </div>
            <br/>
        </div>
    </div>
            ...
            <table id="table" class="table table-striped table-bordered table-hover sortable">
                ...
                <tbody>
                    <?php for ($i = 0; $i < count($this->datos); $i++) { ?>
                        <tr>
                            <td><?php echo $i + 1 ?></td>
                            <td><?php echo $this->datos[$i]['XCONCEPTO'] ?></td>
                            <td><?php echo $this->datos[$i]['REFERENCIA'] ?></td>
                            <td><?php echo $this->datos[$i]['MONTO'] ?></td>
                            <td>
                                <a href="<?php echo BASE_URL?>movimiento/extornar/<?php echo $this->datos[$i]['ID_MOVIMIENTO'] ?>" title="extornar" class="btn btn-info btn-minier"><i class="icon-repeat icon-white"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
